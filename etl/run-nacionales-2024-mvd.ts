/**
 * Orchestrator ETL — Montevideo nacionales-2024 (1ª vuelta), nivel lema (Story 7.4).
 *
 * Reutiliza la geometría y el mapping CRV→barrio ya generados por etl:montevideo.
 * No regenera geometría ni mapping; solo agrega votos y corre los gates.
 *
 * Columnas del CSV nacionales-2024: TipoRegistro, Departamento, CRV, Series, Lema,
 * Descripcion1, CantidadVotos. Compatible con aggregateNacionalesMvd (igual que 2019).
 *
 * Dependencia: npm run etl:montevideo debe haber corrido antes para que existan
 *   data/mappings/montevideo-circuito-barrio.json y
...
const SHARD_OUT = 'public/data/nacionales-2024/montevideo/votes.json';
const OPCIONES_OUT = 'public/data/nacionales-2024/montevideo/opciones.json';

function main(): void {
  console.log('=== ETL Montevideo nacionales-2024 (nivel lema) ===');
  ...
  console.log(`Shard escrito: ${SHARD_OUT}`);
